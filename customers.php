                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="icons edit-icon editCustomerInfo" data-toggle="modal"
                                                data-target="#editCustomer" data-id="<?php echo $row['id']; ?>"
                                        ...
                                        <!-- <td class="text-center"><a class="icons delete-icon btn-delete"
                                                href="javascript:void(0)" data-url="#"
                                                data-key="<?php echo ($row['id']); ?>"><span
                                                    class="es-delete"></span>Delete</a></td>-->
                                        <td>
                                            <form method="post" action="delete-customer.php">
                                                <input name="key" type="hidden"
                                                    value="<?php echo encrypt($row['id']); ?>">

                                                <a data-delete-id="<?php echo $sl_id . "_Delete"; ?>"
                                                    class="btn delete-btn deletePopup"
                                                    href="javascript:void(0)">Delete</a>

                                                <input id="<?php echo $sl_id . "_Delete" ?>" class="realDelete"
                                    ...
                                    echo"<h6 class='error-message'>No Customer Record Found</h6>";
                                }
                            ?>
                                </tbody>
                            </table>
