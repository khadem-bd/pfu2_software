<?php
	...
	function getPaginationCount($sql){
		include "connect.php";
		...
		$html = "<ul>";
		$counter = 1;
		for($i = 0; $i < count($idCounter); $i++){
			$html = $html . "<li><a data-id='" . $idCounter[$i] .  "' href='javascript:void(0)'>" . $counter . "</a></li>";
			$counter++;
		}
		$html = $html . "</ul>";
		return $html;
